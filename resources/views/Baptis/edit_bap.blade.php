      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Edit Data Baptis</h3>
              </div>



	            <form action="/Baptis/ubah/ {{$b->id}}" method="post">
              {{ csrf_field() }}
                @method('PUT')
         ...
         <div class="form-group">
                ...
                <input type="text"  class="form-control" value= " {{$b->jemaat->namalengkap_jem}} "
 readonly />
        ...
        <div class="form-group">
            <label>Pendeta</label>
            <input type="text" name="pendeta_bap" class="form-control" id="pendeta_bap"    value="{{ $b->pendeta_bap}}"/>
        </div>
