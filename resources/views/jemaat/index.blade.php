        ...
        <div class="row">
          <div class="col-15">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <a href="/jemaat/tambah_jem" class="btn btn-success my-3" target="_blank">Tambah Data</a><br>
                ...
                <table id="jemaat" class="table table-bordered table-hover">
                  ...
                  <th> No </th>
                        ...
                        <th scope="col">Surat Baptis & Sidi</th>
...
-->
                                ...
                                <a  href="/jemaat/delete/{{$data->id}}"  class="fa fa-trash" aria-hidden="true" data-toggle="tooltip" ></i></a>
                              </td>
                            </tr>
                            @endforeach
