 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Verifikasi Atestasi Keluar</h1>
          </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
	            ...
	            <form action="/pegawai/upKeluar/{{ $k->id }}" method="post">
              {{ csrf_field() }}
                @method('PUT')
 ...
 readonly />
        ...
        <div class="form-group">
            ...
            <input type="text" name="ket_keluar" class="form-control" id="ket_keluar"  
             value="{{ $k->ket_keluar}}" readonly/>
        </div>
        
        <div class="form-group">
            <label>Gereja Yang Di Tuju</label>
            <input type="text" name="gerejadituju" class="form-control" id="gerejadituju" 
              value="{{ $k->gerejadituju}}" readonly/>
        </div>
        <div class="form-group">
            <label>Alamat</label>
            <input type="text" name="alamat_keluar" class="form-control" id="alamat_keluar" 
              value="{{ $k->alamat_keluar}}" readonly/>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="notelp_keluar" class="form-control" id="notelp_keluar"  
             value="{{ $k->notelp_keluar}}" readonly/>
        </div>
        ...
        <div class="form-group">
                            ...
                            <option  value="Pending" {{ $k->verif == 'Pending'? 'selected': ''}}>Pending</option>
                            
                            <option  value="Terima" {{ $k->verif == 'Terima'? 'selected': ''}}>Terima</option>
                            <option  value="Tolak" {{ $k->verif == 'Tolak'? 'selected': ''}}>Tolak</option>
