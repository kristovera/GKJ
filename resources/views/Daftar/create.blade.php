 ...
 <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="form-group">
        <label for="data">Status Jemaat</label>
...
<label> Status Sidi dan Baptis </label>
        ...
        <div class="form-group">
            ...
            <input type="text" name="alamat_gereja" class="form-control"    />
        </div>
        <div class="form-group">
            <label>No Induk</label>
            <input type="text" name="induk" class="form-control"   value="{{$kode}}" readonly />
        </div>
...
<div class="col-md-12">
    <div class="form-group">
    <label>Surat Baptis & Sidi</label> <br>
